...
export default function Profile() {
  ...
  const menu = [
    ...
    ...(user?.role === 'admin' ? [
      ...
      { icon: 'cube-outline', label: 'Billing — Delivery Challan & Gate Pass', onPress: () => router.push('/admin-delivery') },
      { icon: 'cart-outline', label: 'Billing — Vendors & Purchase Orders', onPress: () => router.push('/admin-purchase') },
      { icon: 'analytics-outline', label: 'Billing — Reports (GSTR-1 / Aging / Ledger)', onPress: () => router.push('/admin-reports') },
